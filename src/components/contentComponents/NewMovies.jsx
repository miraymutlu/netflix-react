...
function ReactSimplyCarouselExample() {
  ...
  return (
    <div style={{ margin: 30, padding: 0, fontSize: 10, color: "white" }}>
      <h className="text-2xl font-medium ml-3">New Movies</h>
      <ReactSimplyCarousel
        ...
        forwardBtnProps={{
          ...
          children: <span style={{ right:10, top:730, position: "absolute" }}>{`>`}</span>,
        }}
        backwardBtnProps={{
          style: {
            alignSelf: "center",
          ...
          children: <span style={{ left:10, top:730, position: "absolute" }}>{`<`}</span>,
        }}
        responsiveProps={[
          {
            itemsToShow: 6,
